...
------------------------------------
  ...
  #. Construct the initial rings using the provided script::
     ...
     that 3 object rings are created in order to test storage policies and EC in the
     SAIO environment.  The EC ring is the only one with all 8 devices as the
     replication style policy probe tests are designed for 3x replication and 4
     devices::
        ...
        Device d1r1z1-127.0.0.1:6021R127.0.0.1:6021/sdb5_"" with 1.0 weight got id 1
        Device d2r1z2-127.0.0.1:6031R127.0.0.1:6031/sdb2_"" with 1.0 weight got id 2
        Device d3r1z2-127.0.0.1:6041R127.0.0.1:6041/sdb6_"" with 1.0 weight got id 3
        Device d4r1z3-127.0.0.1:6011R127.0.0.1:6011/sdb3_"" with 1.0 weight got id 4
        Device d5r1z3-127.0.0.1:6021R127.0.0.1:6021/sdb7_"" with 1.0 weight got id 5
        Device d6r1z4-127.0.0.1:6031R127.0.0.1:6031/sdb4_"" with 1.0 weight got id 6
        Device d7r1z4-127.0.0.1:6041R127.0.0.1:6041/sdb8_"" with 1.0 weight got id 7
        Reassigned 1024 (100.00%) partitions. Balance is now 0.00.
