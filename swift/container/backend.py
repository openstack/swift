...
def record_to_dict(rec):
    """
    Returns a dict representation of the given object table record. The dict
    ...
    :param rec: a tuple
    :returns: a dict, or None if ``rec`` is not truthy
    """
    if rec:
...
def record_to_item(rec):
    ...
    ``storage_policy_index``, ``systags``
     ...
     the same as their respective column values.
    ...
    ts_data, ts_ctype, ts_meta = decode_timestamps(item.pop('created_at'))
    item['data_timestamp'] = ts_data.internal
    item['ctype_timestamp'] = ts_ctype.internal
    item['meta_timestamp'] = ts_meta.internal
    return item
...
class ContainerBroker(DatabaseBroker):
    ...
    * :attr:`pending_file` is always equal to :attr:`_db_file` extended with
    ...
    def list_objects(self, limit=None, marker='', end_marker='',
                     prefix=None, delimiter=None, path=None,
                     storage_policy_index=0, reverse=False,
        ...
        By default, each item in the list is a dict generated by passing the
        object record to the ``record_to_item`` function. The type of each item
        can be varied by passing an alternative ``transform_func``.
        ...
        :param transform_func: an optional function that if given will be
            ...
            :meth:`record_to_item`; defaults to :meth:`record_to_item`.
        ...
        :param table: which db table to query; should be 'object' or 'action'
        :returns: list of type defined by ``transform_func``.
        """
    ...
    def list_objects_iter(self, limit, marker, end_marker, prefix, delimiter,
        ...
        """
        This method is retained for backwards compatibility. It is identical to
        list_objects except the default ``transform_func`` is
        ``transform_record`` such that the returned list has tuples by default.

        Note: this method returns a list, despite the method name suggesting it
        might return an iterable.
        """
        if transform_func is None:
            transform_func = transform_record
        return self.list_objects(limit, marker, end_marker, prefix,
                                 delimiter,
                                 path=path,
                                 storage_policy_index=storage_policy_index,
                                 reverse=reverse,
    ...
    def get_objects(self, limit=None, marker='', end_marker='',
        ...
        return self.list_objects(
            ...
            transform_func=record_to_dict, since_row=since_row,
    ...
    def _really_really_merge_items(self, table, conn, item_list, source):
        ...
        for item in item_list:
            ...
            existing = record_to_dict(records.get(get_ident(item)))
